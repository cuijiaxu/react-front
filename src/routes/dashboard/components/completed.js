    ...
    <div className={styles.sales}>
      ...
      <ResponsiveContainer minHeight={360}>
        <AreaChart data={data}>
          ...
          />
          <Area type="monotone" dataKey="TaskComplete" stroke={color.grass} fill={color.grass} strokeWidth={2} dot={{ fill: '#fff' }} activeDot={{ r: 5, fill: '#fff', stroke: color.green }} />
          <Area type="monotone" dataKey="CardsComplete" stroke={color.sky} fill={color.sky} strokeWidth={2} dot={{ fill: '#fff' }} activeDot={{ r: 5, fill: '#fff', stroke: color.blue }} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  )
